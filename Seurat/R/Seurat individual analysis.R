...
VlnPlot(data, features = c("nFeature_RNA", "nCount_RNA", "percent.mt"), ncol = 3, cols = c("#85d0f5", "#2b2f70"))
dev.off()
...
plot1 <- VariableFeaturePlot(data, cols = c("#85d0f5", "#2b2f70"))
...
## check cluster identities, and which were manually selected based to uncover which manual parameters were used
# BL_A_old <- readRDS("C:/Users/mauri/Desktop/M/Work & Education/Erasmus MC PhD/Projects/Single Cell RNA Sequencing/Seurat/Seurat/results/Exploration results/SCTransform + Leiden - Cellcycle/BL_A/astrocytical-subset.rds")
# BL_N_old <- readRDS("C:/Users/mauri/Desktop/M/Work & Education/Erasmus MC PhD/Projects/Single Cell RNA Sequencing/Seurat/Seurat/results/Exploration results/SCTransform + Leiden - Cellcycle/BL_N/neuronal-subset.rds")
# BL_C_old_neuron <- readRDS("C:/Users/mauri/Desktop/M/Work & Education/Erasmus MC PhD/Projects/Single Cell RNA Sequencing/Seurat/Seurat/results/Exploration results/SCTransform + Leiden - Cellcycle/BL_C/mixed-neuronal-subset.rds")
# BL_C_old_astrocyte <- readRDS("C:/Users/mauri/Desktop/M/Work & Education/Erasmus MC PhD/Projects/Single Cell RNA Sequencing/Seurat/Seurat/results/Exploration results/SCTransform + Leiden - Cellcycle/BL_C/mixed-astrocytical-subset.rds")
# BL_A_new <- readRDS("C:/Users/mauri/Desktop/M/Work & Education/Erasmus MC PhD/Projects/Single Cell RNA Sequencing/Seurat/Seurat/results/SCTransform + Leiden - Cellcycle + Annotation/BL_A/BL_A_astrocytical_subset.rds")
# BL_N_new <- readRDS("C:/Users/mauri/Desktop/M/Work & Education/Erasmus MC PhD/Projects/Single Cell RNA Sequencing/Seurat/Seurat/results/SCTransform + Leiden - Cellcycle + Annotation/BL_N/BL_N_neuronal_subset.rds")
# BL_C_new_neuron <- readRDS("C:/Users/mauri/Desktop/M/Work & Education/Erasmus MC PhD/Projects/Single Cell RNA Sequencing/Seurat/Seurat/results/SCTransform + Leiden - Cellcycle + Annotation/BL_C/BL_C_neuronal_subset.rds")
# BL_C_new_astrocyte <- readRDS("C:/Users/mauri/Desktop/M/Work & Education/Erasmus MC PhD/Projects/Single Cell RNA Sequencing/Seurat/Seurat/results/SCTransform + Leiden - Cellcycle + Annotation/BL_C/BL_C_astrocytical_subset.rds")

...
integrated <- readRDS("C:/Users/mauri/Desktop/Single Cell RNA Sequencing/Seurat/results/Pipe SCTv2 +new_panel_selection +01-06-2022/integrated - old selection/BL_A + BL_C/BL_A + BL_C.rds")

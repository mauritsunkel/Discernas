...
rds.files <- c(
  "C:/Users/mauri/Desktop/Single Cell RNA Sequencing/Seurat/results/Pipe_29-06 cell_level_selection/integrated/BL_N + BL_C/after_selection_old/BL_N + BL_C.rds"
)

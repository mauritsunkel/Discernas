...
rds.files <- c(
  "C:/Users/mauri/Desktop/Single Cell RNA Sequencing/Seurat/results/Pipe_29-06 cell_level_selection/integrated/BL_A + BL_C/after_selection_new/BL_A + BL_C.rds"
)

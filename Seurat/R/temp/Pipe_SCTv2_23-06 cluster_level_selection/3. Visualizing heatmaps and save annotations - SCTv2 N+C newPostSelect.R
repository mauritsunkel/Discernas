...
## TODO testing
# set RData folder
RData_folder <-"C:/Users/mauri/Desktop/Single Cell RNA Sequencing/Seurat/data/Kriegstein/RData/Pipe_SCTv2_23-06/N+C newPostSelect"
# set sample(s)
samples <- c("BL_N + BL_C")
# set file(s)
rds.files <- c("C:/Users/mauri/Desktop/Single Cell RNA Sequencing/Seurat/results/Pipe_SCTv2_23-06/integrated - new selection/BL_N + BL_C/after_selection/BL_N + BL_C.rds")

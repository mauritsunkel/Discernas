...
### USER PARAMETERS ###
# set RData folder
RData_folder <-"C:/Users/mauri/Desktop/Single Cell RNA Sequencing/Seurat/data/Kriegstein/RData/t149"
# set sample(s)
samples <- c("t149")
# set file(s)
rds.files <- c(
  "C:/Users/mauri/Desktop/Single Cell RNA Sequencing/Seurat/results/Mark organoids first run/t149/t149.rds"
  )

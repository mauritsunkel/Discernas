...
### USER PARAMETERS ###
# set RData folder
RData_folder <-"C:/Users/mauri/Desktop/Single Cell RNA Sequencing/Seurat/data/Kriegstein/RData/t275"
# set sample(s)
samples <- c("t275")
# set file(s)
rds.files <- c(
  "C:/Users/mauri/Desktop/Single Cell RNA Sequencing/Seurat/results/Mark organoids first run/t275/t275.rds"
  )

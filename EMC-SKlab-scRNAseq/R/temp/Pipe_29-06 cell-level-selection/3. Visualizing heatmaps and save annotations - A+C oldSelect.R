...
## TODO testing
# set RData folder
RData_folder <-"C:/Users/mauri/Desktop/Single Cell RNA Sequencing/Seurat/data/Kriegstein/RData/Pipe_29-06/A+C oldSelect"
# set sample(s)
samples <- c("BL_A + BL_C")
# set file(s)
rds.files <- c("C:/Users/mauri/Desktop/Single Cell RNA Sequencing/Seurat/results/Pipe_29-06 cell_level_selection/integrated/BL_A + BL_C/after_selection_old/BL_A + BL_C.rds")
